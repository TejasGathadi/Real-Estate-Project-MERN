      ...
      {listing && !loading && !error && (
        <div>
          ...
          <div className="flex flex-col max-w-4xl mx-auto p-3 my-7 gap-4">
            ...
            <p className="flex items-center mt-6 gap-2 text-slate-600 text-sm font-bold">
            ...
            <ul className="text-green-900 font-semibold text-sm flex flex-wrap i tems-center gap-4 sm:gap-6">
